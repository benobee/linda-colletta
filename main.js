...
const App = {
    ...
    cacheDOM() {
        ...
        this.productCollection = body.querySelector(".app.has-custom-shop");
        this.productPage = body.querySelector(".collection-type-products.view-item");
    },
    onDOMContentLoaded() {
    ...
    const Site = {
        init() {
            document.addEventListener("DOMContentLoaded", () => {
                ...
                if (this.productCollection) {
                    const collection = this.productCollection;
                ...
                if (this.productPage) {
                    ...
                    if (this.testAccess()) {
                        this.productPage.querySelector(".ProductItem-summary").classList.add("price-visible");
                    } else {
                        this.productPage.querySelector(".ProductItem-summary").classList.add("price-hidden");
                    }
        ...
        buildComponents() {
            ...
            Vue.component('enquiry-button', {
                template: `<div v-on:click="showForm" class="button-wrapper">
